...
class ViewController: NSViewController {
    ...
    override func viewDidLoad() {
        ...
        usuarioLog.append(UsuarioModelo(0, "Default User", "def", "def", "def@g.com","4771234567", "no binarie", 10, "123", "123","Admin",formatStringToDate(date: "2002/10/10")))
        usuarioLog.append(UsuarioModelo(1, "Uriel", "Resendiz", "Medina", "murmi@lasalle.com","4771234567", "no binarie", 10, "123", "123","Admin", formatStringToDate(date: "2003/04/26")))
        usuarioLog.append(UsuarioModelo(2, "Pedro", "f", "f", "p@g.com","4771234567", "no binarie", 10, "123", "123","Ventas", formatStringToDate(date: "2004/08/23")))
        usuarioLog.append(UsuarioModelo(3, "Cliente", "f", "f", "c@g.com","4771234567", "no binarie", 10, "123", "123","Cliente", formatStringToDate(date: "2001/02/17")))
        usuarioLog.append(UsuarioModelo(4, "vale", "b", "m", "v@g.com","4771234567", "no binarie", 20, "123", "123","Compras", formatStringToDate(date: "1996/03/20")))
